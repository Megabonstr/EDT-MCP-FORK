...
| [`modify_dcs_settings`](docs/tools/modify_dcs_settings.md) | Author a DCS default/variant settings tree through EDT's native model: total fields, selection, filters, sorting, nested groups, charts, conditional appearan… |
